...
RPC Toolkit is a cross-runtime JSON-RPC 2.0 ecosystem for backend services,
embedded devices, Android apps, browser clients, Node-RED flows, and integration
workloads.
...
The ecosystem has interoperability coverage across JavaScript, .NET, PHP,
Python, Java, Arduino/ESP32/ESP8266, and Node-RED paths. The validation material
is maintained as evidence, not as marketing copy.
...
- [OpenRPC and OpenAPI direction](OPENAPI_OPENRPC.md)
- [Security model](SECURITY_MODEL.md)

## Source

- [GitHub repository](https://github.com/n-car/rpc-toolkit)
- [Related repositories](https://github.com/n-car?tab=repositories&q=rpc-&type=&language=&sort=)
