...
Use the maintainer contact published in the relevant implementation repository. If the issue affects this ecosystem hub or multiple repositories, submit a [private vulnerability report](https://github.com/n-car/rpc-toolkit/security/advisories/new).
